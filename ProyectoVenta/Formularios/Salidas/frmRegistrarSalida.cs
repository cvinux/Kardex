...
namespace ProyectoVenta.Formularios.Salidas
{
    public partial class frmRegistrarSalida : Form
    {
        ...
        private void btnagregar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Debe ingresar el porcentaje de descuento del producto", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            if (operaciones > 0)
            {
                ...
                descuento = Convert.ToDecimal(txtdescuento.Text.ToString());
        ...
        private void calcularDescuento()
        {
            ...
            if (dgvdata.Rows.Count > 0)
            {
                foreach (DataGridViewRow row in dgvdata.Rows)
                {
                    descuento += Convert.ToDecimal(row.Cells["TotalDescuento"].Value.ToString());
                }
        ...
        private void calcularNuevoTotal()
        {
            ...
            lblnuevototal.Text = total.ToString("0.00");
        }
        ...
        private void btnguardarsalida_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow row in dgvdata.Rows)
            {
                olista.Add(new DetalleSalida()
                {
                    ...
                    Descuento = row.Cells["TotalDescuento"].Value.ToString(),
